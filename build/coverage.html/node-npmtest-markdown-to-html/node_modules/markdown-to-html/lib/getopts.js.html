...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-markdown-to-html/node_modules/markdown-to-html/lib/getopts.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-markdown-to-html/node_modules/markdown-to-html/lib/getopts.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-markdown-to-html/node_modules/markdown-to-html/lib/</a> &#187; getopts.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// This module parses command line args and puts them in a hash which is returned as opts.
var path = require('path');
var name = path.basename(process.argv[1]);
&nbsp;
module.exports = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  var opts = require('yargs')</span>
